...
function onLoad() {
    ...
    var topMargin = (windowHeight - canvasHeight) / 2;
    renderCanvas.style.marginTop = topMargin + 'px';
    ...
    */
    ...
    currentWindow = windowLayout["loading"];
...
function renderMainContext() {
    ...
    stepContext.drawImage(mainCanvas, 0, 0, screenWidth, screenHeight, 0, 0, screenWidth / 2, screenHeight / 2 );

    renderContext.drawImage(stepCanvas, 0, 0, screenWidth / 2, screenHeight / 2, 0, 0, canvasWidth, canvasHeight );
}
...
function drawBackground(windowTitle, enableMenu) {
    ...
    mainContext.fillStyle = "rgb(128, 128, 128)";
    mainContext.fillRect(0, 0, screenWidth, screenHeight);        

    mainContext.font = '112px ' + globalFont;
    mainContext.fillStyle = "white";
    mainContext.textAlign = "center";
    mainContext.fillText (windowTitle, screenWidth / 2, 195 );
